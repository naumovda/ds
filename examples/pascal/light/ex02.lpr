...
type
  ColorEnum = 0..LastColor;

  IColorable = interface
    procedure SetColor(AColor: ColorEnum);
  ...
  TColoredLight = class(TLight, IColorable)
    private
      color: integer;
    public
      procedure SetColor(AColor: ColorEnum);
...
procedure TColoredLight.SetColor(AColor:ColorEnum);
begin
...
function TColoredLight.GetColor: ColorEnum;
begin
  Result := color;
end;
